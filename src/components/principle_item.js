...
const Item = (props) => {
  ...
  const mainText = {
    1: "Once we tested and confirmed what to build. We ship minimum lovable products, not minimum viable products to our customers. That means we do not compromise on customer experience. We do not release final products with ‘broken windows’! If we ship it, we ship it really, really, $%cking good!",
    ...
    5: "If we can not measure the success of a product, we do not release the product.And if the product does not solve a clear, measurable customer or business need, we kill it to keep the user experience clean and the code maintainable. Regardless of the size of the product.",
