...
const Item = (props) => {
  ...
  const mainText = {
    ...
    3: "Be close to the consumer. We don’t assume what consumers want. We speak to our consumers. Be specific and know who you build it for? And if it doesn’t prove value, we kill it.",
    ...
    5: "If we can not measure the success of a product, we do not release the product. If the product does not solve a clear, measurable consumer or business need, we kill it to keep the user experience clean and the code maintainable. Regardless of the size of the product.",
